    ...
    <header class="fixed items-center flex left-60 top-0 right-0 px-16 z-50 h-16 bg-purple-900	">
      ...
      >
        ...
        >
          ...
          <form id="level-search" class="relative block w-full max-w-md">
            <div
              ...
              class="relative rounded-2xl h-10 bg-white"
            >
              <div
                id="input-wrapper"
                class="absolute top-0 left-9 bottom-0 right-2.5"
              >
                <button
                  id="search-icon"
                  class="flex rounded-full	items-center leading-normal text-center cursor-pointer relative"
                >
                  {/* Need Icon */}
                </button>
                <input
                  type="text"
                  class="m-0 inline-block text-base h-8 top-0.5 relative border-0 leading-8	py-1"
        ...
        <div id="level-right" class="flex grow mt-0 items-center justify-end">
          <a
            id="Upgrade"
            class="mr-3 py-2.5 px-2.5 rounded-2xl bg-violet-500 tracking-wide leading-5	text-white  "
          >
            Upgrade Account
          </a>
          <div id="Download" class="mr-3 bg-amber-200	 relative rounded-2xl">
            <a
              id="Download"
              class="flex py-2.5 px-2.5 items-center rounded-full leading-5 text-center cursor-pointer relative "
            >
              Download App
              {/* Need Icon */}
            </a>
          ...
          <div id="setting-item" class="relative mr-2.5">
            <button class="w-10 h-10 flex items-center justify-center rounded-full bg-white leading-normal cursor-pointer relative"></button>
          </div>
