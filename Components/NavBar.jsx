  ...
  <div id="level" class="relative w-full z-10 flex items-center justify-between">
    ...
    ></path>
      ...
      <form id="level-search" class="relative  w-full max-w-md">
        <div id="level-search-container" class="relative rounded-2xl h-10 bg-bgWhite">
        <button id="search-icon" class="absolute left-2.5 h-full  rounded-full	items-center leading-normal text-center cursor-pointer relative">
              <svg viewBox="0 0 512 512" height="20px" fill="black" class="mr-3">   
                <path
...
{/* Need fixed */}
      <div id="input-wrapper" class="relative text-bgDarkBg inline-block  	 ">
          <input type='text'class="relative border-none h-5			 " placeholder='Search for music...'> 
          </input>
        </div>
    ...
    <div id="level-right" class="flex grow mt-0 items-center justify-end">
      <a id="Upgrade" class="mr-3 py-2.5 px-2.5 rounded-2xl bg-bgDarkInactive tracking-wide leading-5	text-textDarkText  ">
        Upgrade Account
      </a>
      <div id="Download" class="mr-3 bg-bgDarkInactive	 relative rounded-2xl">
        <a id="Download" class="flex py-2.5 px-2.5 text-textDarkText items-center rounded-full leading-5 text-center cursor-pointer relative ">
          <i id="icon" class="m-1">
            <svg class="w-5 h-5" viewBox='0 0 20 20' fill="none">
              <path d="M17.4966 13.4203V13.6633C17.4966 14.5857 16.7489 15.3333 15.8266 15.3333H4.16658C3.24427 15.3333 2.49658 14.5857 2.49658 13.6633V5.00334C2.49658 4.08103 3.24427 3.33334 4.16658 3.33334H9.99658" stroke='currentColor' stroke-linecap="round">

              </path>
              <path fillRule='evenodd' clip-rule="even-odd" d="M14.4979 11.6247C14.4103 11.7021 14.2955 11.7493 14.1696 11.75C14.1687 11.75 14.1678 11.75 14.1668 11.75C14.1659 11.75 14.165 11.75 14.1641 11.75C14.0382 11.7493 13.9233 11.7021 13.8358 11.6247L10.5043 8.70963C10.2964 8.52779 10.2754 8.21191 10.4572 8.00409C10.6391 7.79627 10.9549 7.77521 11.1628 7.95705L13.6668 10.1481V3.33334C13.6668 3.0572 13.8907 2.83334 14.1668 2.83334C14.443 2.83334 14.6668 3.0572 14.6668 3.33334V10.1481L17.1709 7.95705C17.3787 7.77521 17.6946 7.79627 17.8765 8.00409C18.0583 8.21191 18.0372 8.52779 17.8294 8.70963L14.4979 11.6247Z" stroke="currentColor" stroke-width="1" stroke-linecap="round">

                </path>

              <path d="M6 16.8333H14" stroke="currentColor" stroke-width="1" stroke-linecap ="round">
