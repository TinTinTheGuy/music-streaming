...
<header class="fixed items-center flex left-60 top-0 right-0 px-16 z-50 h-16 bg-bgDarkBg	">
  <div id="level" class="relative w-full z-10 flex items-center justify-between">
    ...
    <div id="setting-tem" class="relative mr-2.5">
        <button class="flex items-center cursor-none opacity-30 select-none bg-bgDarkInactive leading-normal cursor-pointer relative">
