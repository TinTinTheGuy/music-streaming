...
const SideBar = () => {
  return (
    <aside
      id="sidebar-logo"
      class="z-50 fixed w-60 h-screen  pt-16 pb-12 bg-bgDarkBg	max-md:w-16 "
      aria-label="Sidebar"
    >
      <div id="sidebar-wrapper" class="h-full flex flex-col ">
        <nav id="sidebar-navbar" class="w-full">
          <div
            id="sidebar-brand"
            class="fixed top-0 flex items-center w-60 h-16 pr-6 pl-7 max-md:p-0 max-md:w-16 max-md:justify-center"
          >
            ...
            <li class="font-bold text-textDarkText  border-solid border-transparent">
              <a class="flex items-center text-sm font-medium py-3 px-5 max-md:justify-center  max-md:px-0 max-md:w-16  max-md:block ">
                ...
                >
                  <path
                    fill="white"
                    d="M 3.25 12 C 3.25 7.16751 7.16751 3.25 12 3.25 C 16.8325 3.25 20.75 7.16751 20.75 12 C 20.75 16.8325 16.8325 20.75 12 20.75 C 7.16751 20.75 3.25 16.8325 3.25 12 Z M 12 1.75 C 6.33908 1.75 1.75 6.33908 1.75 12 C 1.75 17.6609 6.33908 22.25 12 22.25 C 17.6609 22.25 22.25 17.6609 22.25 12 C 22.25 6.33908 17.6609 1.75 12 1.75 Z M 9.25 12 C 9.25 10.4812 10.4812 9.25 12 9.25 C 13.5188 9.25 14.75 10.4812 14.75 12 C 14.75 13.5188 13.5188 14.75 12 14.75 C 10.4812 14.75 9.25 13.5188 9.25 12 Z M 12 7.75 C 9.65279 7.75 7.75 9.65279 7.75 12 C 7.75 14.3472 9.65279 16.25 12 16.25 C 14.3472 16.25 16.25 14.3472 16.25 12 C 16.25 9.65279 14.3472 7.75 12 7.75 Z"
                  />
                </svg>

                <p class="max-md:invisible"> Explore</p>
              </a>
            </li>
            <li class="font-bold text-textDarkText  border-solid border-transparent">
              <a class="flex items-center text-sm font-medium py-3 px-5 max-md:justify-center  max-md:px-0 max-md:w-16  max-md:block ">
        ...
        <div id="sidebar-navbar-3" class="relative w-full h-full">
          <div class="relative overflow-hidden -mr-1.5 mb-0  mt-4">
            <nav class="w-full text-textDarkText">
              <ul>
                <li class="font-bold   border-solid border-transparent">
                  <a class="flex items-center text-sm font-medium py-3 px-5 max-md:justify-center  max-md:px-0 max-md:w-16  max-md:block ">
                    {/* SVG or ICONS with margin right 12px */}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="font-bold  border-solid border-transparent">
                  <a class="flex items-center text-sm font-medium py-3 px-5 max-md:justify-center  max-md:px-0 max-md:w-16  max-md:block ">
                    ...
                    >
                      <path
                        fill="white"
                        d="M 12 17 L 7.01888 19.6187 C 6.65207 19.8116 6.22335 19.5001 6.29341 19.0916 L 7.24472 13.5451 L 3.21491 9.61699 C 2.91815 9.32773 3.08191 8.82374 3.49202 8.76415 L 9.06107 7.95491 L 11.5516 2.90849 C 11.735 2.53687 12.265 2.53687 12.4484 2.90849 L 14.9389 7.95491 L 20.508 8.76415 C 20.9181 8.82374 21.0818 9.32773 20.7851 9.61699 L 16.7553 13.5451 L 17.7066 19.0916 C 17.7766 19.5001 17.3479 19.8116 16.9811 19.6187 L 12 17 Z"
                      />
                    </svg>
                    <p class="max-md:invisible"> Treding</p>
                  </a>
                </li>
              </ul>
            </nav>
            ...
            <div
              id="login-noti"
              class="py-3.5 px-2 rounded-lg text-center my-2.5 mx-5 text-textDarkText bg-bgDarkSecondary"
            >
