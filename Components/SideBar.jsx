...
const SideBar = () => {
  return (
        <aside id="sidebar-logo" class="z-50 fixed w-60 h-screen  pt-16 pb-12 bg-bgDarkBg	max-md:w-16 " aria-label="Sidebar">
        <div id="sidebar-wrapper"class="h-full flex flex-col ">
            <nav id="sidebar-navbar" class="w-full">
            <div id="sidebar-brand" class="fixed top-0 flex items-center w-60 h-16 pr-6 pl-7 max-md:p-0 max-md:w-16 max-md:justify-center">
                ...
                <div class="relative overflow-hidden -mr-1.5 mb-0  mt-4">
                    <nav class="w-full text-textDarkText">
                        ...
                        <p class="max-md:invisible">    Library</p>
                            ...
                            <li class="font-bold  border-solid border-transparent">
                                <a class="flex items-center text-sm font-medium py-3 px-5 max-md:justify-center  max-md:px-0 max-md:w-16  max-md:block ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 p-2 max-md:mx-auto fill-white max-md:p-0	" viewBox="0 0 24 24"><path fill='white' d="M 12 17 L 7.01888 19.6187 C 6.65207 19.8116 6.22335 19.5001 6.29341 19.0916 L 7.24472 13.5451 L 3.21491 9.61699 C 2.91815 9.32773 3.08191 8.82374 3.49202 8.76415 L 9.06107 7.95491 L 11.5516 2.90849 C 11.735 2.53687 12.265 2.53687 12.4484 2.90849 L 14.9389 7.95491 L 20.508 8.76415 C 20.9181 8.82374 21.0818 9.32773 20.7851 9.61699 L 16.7553 13.5451 L 17.7066 19.0916 C 17.7766 19.5001 17.3479 19.8116 16.9811 19.6187 L 12 17 Z"/></svg>
