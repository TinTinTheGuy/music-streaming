...
const SideBar = () => {
  return (
        <aside id="sidebar-logo" class="z-50 fixed w-60 h-screen  pt-16 pb-12 bg-purple-600" aria-label="Sidebar">
        <div id="sidebar-wrapper"class="h-full flex flex-col ">
            ...
            <div id="sidebar-navbar-3" class="relative w-full h-full">
                <div class="relative overflow-hidden -mr-1.5 mb-0  mt-4">
                    ...
                    <div id="login-noti" class="py-3.5 px-2 rounded-lg text-center my-2.5 mx-5 text-white bg-gray-500">
